<template>
  <div class="container-page space-y-5">
    <header>
      ...
      <p class="text-secondary mt-1">Your keys, machine access, and storage at a glance.</p>
    </header>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
      ...
      <SectionCard title="Request access" icon="i-carbon-add-alt">
        <RequestAccessForm :machines="machines" :default-username="auth.name" @requested="onRequested" />
      </SectionCard>
